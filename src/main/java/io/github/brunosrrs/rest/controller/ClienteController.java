...
//definindo o controlador REST, que vai receber comandos HTTP
@RestController
//mapeando o url base da aplicação
...
public class ClienteController {
    ...
    public List<Cliente> find (Cliente filtro){
        ExampleMatcher matcher = ExampleMatcher.matching()
                .withIgnoreCase()                           //containing: qualquer posição que tiver a string(filtro) ele vai encontrar
